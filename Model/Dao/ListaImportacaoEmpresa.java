...
import com.mycompany.tentandoprojetopoo2.Model.Importacao;
 ...
 * @author rafin
 */
public class ListaImportacaoEmpresa {
    public static List<Importacao> listaImportacoesEmpresaBD(String CNPJ) {
        List<Importacao> lista = new ArrayList<>();
        
        String sql = "SELECT * FROM Importacao WHERE CNPJ_Importador = ?";
